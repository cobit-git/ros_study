...
void msgCallback(const ros_mini::MsgMini::ConstPtr& msg)
{
  ROS_INFO("recieve msg = %f", msg->distance);        // Prints the 'data' message
}
...
int main(int argc, char **argv)                         // Node Main Function
{
  ...
  ros::Subscriber ros_serial_sub = nh.subscribe("ros_mini_msg", 100, msgCallback);
