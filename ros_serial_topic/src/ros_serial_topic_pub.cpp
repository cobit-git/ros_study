...
#include "ros_serial_topic/MsgSer.h"    // MsgSerial Message File Header. The header file is automatically created when building the package.
...
int main(int argc, char **argv)                 // Node Main Function
{
  ...
  ros::Publisher ros_serial_pub = nh.advertise<ros_serial_topic::MsgSer>("ros_ser_msg", 100);

  // Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
  ros::Rate loop_rate(10);

  ros_serial_topic::MsgSer msg;     // Declares message 'msg' in 'Msgserial' message file format
